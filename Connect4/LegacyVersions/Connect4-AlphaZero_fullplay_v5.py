...
class NNManager:
    def __init__(self, hyperparams=None):
        ...
        if os.path.exists(NN_MODEL_FILE):
            ...
            print(f"Model loaded. Training iterations: {self.train_iterations}")
        else:
...
class Connect4GUI(tk.Tk):
    ...
    def _train(self):
        ...
        def worker():
            ...
            # We could hide the training UI after a delay, or keep it visible to show the last status
            # Uncommenting this would hide the training UI after training completes
            # self.after(5000, self._hide_training_ui)
