...
def main():
    ...
    btn_run_app = ttk.Button(frm_buttons_top, text="Run app", style='Blue.TButton', width=15)  # New Run app button
    btn_exit = ttk.Button(frm_buttons_top, text="Exit", width=10)
    btn_cancel.pack(side=tk.LEFT, padx=5)
    btn_start.pack(side=tk.LEFT, padx=5)
    btn_stop.pack(side=tk.LEFT, padx=5)
    btn_config.pack(side=tk.LEFT, padx=5)
    btn_check_models.pack(side=tk.LEFT, padx=5)
    btn_run_app.pack(side=tk.LEFT, padx=5)  # Add Run app button here
