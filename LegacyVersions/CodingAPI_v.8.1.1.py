...
def open_run_app_dialog(parent):
    ...
    current_dir_entry = ttk.Entry(dir_frame, textvariable=current_dir_var, width=80)  # Increased width from 50 to 80
    ...
    selected_file_entry = ttk.Entry(selected_file_frame, textvariable=selected_file_var, width=80)  # Increased width from 50 to 80
