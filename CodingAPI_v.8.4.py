...
"""
CodingAPI - Enhanced version 8.4
...
def main():
    ...
    Tooltip(label_filename, "Enter the base filename for saving generated code (without extension)")
    ...
    Tooltip(btn_config, "Configure API keys and view available models")
    Tooltip(btn_check_models, "Select which models to use for code generation and auditing")
