...
CodingAPI Database Browser - Version 2.0
...
class CodingAPIBrowser:
    ...
    def setup_code_tab(self):
        ...
        self.view_combo.bind("<<ComboboxSelected>>", self.update_code_view)
        
        # Export button
        self.export_btn = ttk.Button(selector_frame, text="Export to File", command=self.export_code)
        self.export_btn.pack(side=tk.RIGHT)
        
        # Run App button
        self.run_btn = ttk.Button(selector_frame, text="Run App", command=self.run_code)
