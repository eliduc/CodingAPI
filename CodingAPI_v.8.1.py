...
"""
CodingAPI - Enhanced version 8.0
...
def open_run_app_dialog(parent):
    ...
    current_dir_entry = ttk.Entry(dir_frame, textvariable=current_dir_var, width=50)
    ...
    selected_file_entry = ttk.Entry(selected_file_frame, textvariable=selected_file_var, width=50, state="readonly")
    ...
    def on_view_file():
        ...
        try:
            ...
            text_widget = scrolledtext.ScrolledText(text_frame, width=80, height=30, wrap=tk.NONE)
    ...
    def on_run_app():
        ...
        try:
            ...
            output_text = scrolledtext.ScrolledText(text_frame, width=80, height=30, bg="black", fg="white")
    ...
    # Cancel button
    cancel_button = ttk.Button(button_frame, text="Cancel", command=run_dialog.destroy)
    cancel_button.pack(side=tk.LEFT, padx=5)
    
    # View button
    view_button = ttk.Button(button_frame, text="View", command=on_view_file)
    view_button.pack(side=tk.LEFT, padx=5)
    
    # Run button
    run_button = ttk.Button(button_frame, text="Run app", command=on_run_app)
...
def main():
    ...
    label_description = ttk.Label(frm_desc_header, text="Program Description", style='Bold.TLabel')
