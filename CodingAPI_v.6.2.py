#!/usr/bin/env python3
"""
CodingAPI - Enhanced version 6.1
...
Updated with correct temperature and reasoning parameter settings.
...
LLM_MAP = {
    ...
    # DeepSeek models
    "DeepSeek R1":          {"model": "deepseek-reasoner", "family": "DeepSeek", "temperature_allowed": False},
}
...
# Optimal Parameter Constants for different model families
...
OPENAI_PARAMS = {
    # GPT-4.1 parameters
    "gpt-4.1": {
        "web_app": {"temperature": 0.2, "top_p": 0.95, "frequency_penalty": 0.1, "presence_penalty": 0.0},
        "data_science": {"temperature": 0.3, "top_p": 0.95, "frequency_penalty": 0.0, "presence_penalty": 0.0},
        "algorithm": {"temperature": 0.1, "top_p": 1.0, "frequency_penalty": 0.0, "presence_penalty": 0.0},
        "default": {"temperature": 0.2, "top_p": 0.95, "frequency_penalty": 0.0, "presence_penalty": 0.0}
    },
    # GPT-4o parameters
    "gpt-4o": {
        "web_app": {"temperature": 0.2, "top_p": 0.95, "frequency_penalty": 0.1, "presence_penalty": 0.0},
        "data_science": {"temperature": 0.3, "top_p": 0.95, "frequency_penalty": 0.0, "presence_penalty": 0.0},
        "algorithm": {"temperature": 0.2, "top_p": 1.0, "frequency_penalty": 0.0, "presence_penalty": 0.0},
        "default": {"temperature": 0.3, "top_p": 0.95, "frequency_penalty": 0.0, "presence_penalty": 0.0}
    },
    # GPT-4.1-mini/nano parameters
    "gpt-4.1-mini": {
        "web_app": {"temperature": 0.3, "top_p": 0.6, "frequency_penalty": 0.1, "presence_penalty": 0.0},
        "data_science": {"temperature": 0.4, "top_p": 0.6, "frequency_penalty": 0.0, "presence_penalty": 0.0},
        "algorithm": {"temperature": 0.3, "top_p": 0.7, "frequency_penalty": 0.0, "presence_penalty": 0.0},
        "default": {"temperature": 0.3, "top_p": 0.6, "frequency_penalty": 0.0, "presence_penalty": 0.0}
    },
...
# Claude Parameters
CLAUDE_PARAMS = {
    # Claude 3.7 Sonnet parameters
    "claude-3-7-sonnet-20250219": {
        "web_app": {"temperature": 0.1, "thinking_budget": 16000},
        "data_science": {"temperature": 0.1, "thinking_budget": 12000},
        "algorithm": {"temperature": 0.0, "thinking_budget": 32000},
        "default": {"temperature": 0.1, "thinking_budget": 16000}
    },
    # Claude 3 Opus parameters
    "claude-3-opus-latest": {
        "web_app": {"temperature": 0.2, "thinking_budget": 0},
        "data_science": {"temperature": 0.2, "thinking_budget": 0},
        "algorithm": {"temperature": 0.1, "thinking_budget": 0},
        "default": {"temperature": 0.2, "thinking_budget": 0}
    },
    # Claude 3 Haiku parameters
    "claude-3-haiku-20240307": {
        "web_app": {"temperature": 0.2, "thinking_budget": 0},
        "data_science": {"temperature": 0.3, "thinking_budget": 0},
        "algorithm": {"temperature": 0.1, "thinking_budget": 0},
        "default": {"temperature": 0.2, "thinking_budget": 0}
    },
    # Default parameters for other Claude models
    "default": {
        "web_app": {"temperature": 0.1, "thinking_budget": 0},
        "data_science": {"temperature": 0.2, "thinking_budget": 0},
...
# Gemini Parameters
GEMINI_PARAMS = {
    # Gemini 2.5 Pro parameters
    "gemini-2.5-pro-exp-03-25": {
        "web_app": {"temperature": 0.2, "top_p": 0.9, "top_k": 30, "thinking_budget": 8192},
        "data_science": {"temperature": 0.3, "top_p": 0.85, "top_k": 20, "thinking_budget": 12288},
        "algorithm": {"temperature": 0.1, "top_p": 0.8, "top_k": 15, "thinking_budget": 16384},
        "default": {"temperature": 0.2, "top_p": 0.85, "top_k": 20, "thinking_budget": 8192}
    },
    # Gemini 2.0 Flash parameters
    "gemini-2.0-flash": {
        "web_app": {"temperature": 0.2, "top_p": 0.9, "top_k": 30, "thinking_budget": 4096},
        "data_science": {"temperature": 0.3, "top_p": 0.85, "top_k": 20, "thinking_budget": 6144},
        "algorithm": {"temperature": 0.1, "top_p": 0.8, "top_k": 15, "thinking_budget": 8192},
        "default": {"temperature": 0.2, "top_p": 0.85, "top_k": 20, "thinking_budget": 4096}
    },
...
DEEPSEEK_PARAMS = {
    ...
    # Default parameters for other DeepSeek models (assuming Coder-like)
    "default": {
        "web_app": {"temperature": 0.0, "top_p": 0.95},
        "data_science": {"temperature": 0.0, "top_p": 0.95},
        "algorithm": {"temperature": 0.0, "top_p": 0.95},
        "default": {"temperature": 0.0, "top_p": 0.95}
    }
}
    ...
    def get_deepseek_generation_prompt(description, language, file_content=None):
        ...
        if file_content:
            return (
                f"It is required to modify the program below in accordance with the task: {description}. "
                f"If the program is written in a language different from {language}, it should be translated (re-written) in {language}.\n\n"
                f"Please reason step by step through this task before writing any code. "
...
def generate_with_openai(client, model, description, language, file_content=None, temp_allowed=False):
    ...
    # Check if this is a reasoning model (o1-pro, o3, o3-mini, o4-mini)
    is_reasoning_model = model in ["o1-pro", "o3-2025-04-16", "o3-mini", "o4-mini"]
        ...
        try:
            ...
            if is_reasoning_model:
                kwargs = {
                    "model": model,
                    "messages": [
                        {"role": "developer", "content": system_prompt},  # Use developer role for reasoning models
                        {"role": "user", "content": prompt_text}
                    ],
                    "max_completion_tokens": MAX_OUTPUT_TOKENS,  # Use appropriate token parameter
                    "reasoning_effort": "high"  # Set maximum reasoning effort
                }
            else:
                kwargs = {
                    "model": model,
...
def generate_with_claude(client, model, description, language, file_content=None, temp_allowed=True):
    ...
    try:
        kwargs = {
            ...
            "stream": True  # Enable streaming for long-running requests
        }
        ...
        if is_claude_3_7_sonnet and params["thinking_budget"] > 0:
            ...
            # When thinking is enabled, we can only use temperature=1 or omit it entirely
            # Omitting temperature is preferred as it will use the API default
        elif temp_allowed:
...
def correct_with_claude(client, model, initial_prompt, program_code, code_analysis, temp_allowed=True):
    ...
    try:
        ...
        # Join all content chunks to get the full response
...
def generate_with_deepseek(client, model, description, language, file_content=None, temp_allowed=False):
    """
    ...
    try:
        ...
        # DeepSeek R1 requires specific temperature settings
        kwargs["temperature"] = params["temperature"]
        kwargs["top_p"] = params["top_p"]
...
def audit_with_deepseek(client, model, prompt_text, code_text, temp_allowed=False):
    """
...
def correct_with_deepseek(client, model, initial_prompt, program_code, code_analysis, temp_allowed=False):
    """
