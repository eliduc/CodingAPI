...
"""
CodingAPI - Enhanced version 7.6
...
def main():
    ...
    btn_exit = ttk.Button(frm_buttons_top, text="Exit", width=10)  # New Exit button
    ...
    btn_exit.pack(side=tk.RIGHT, padx=5)  # Pack on the RIGHT side
